...
const HomeClient = ({ email }: { email: string }) => {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "You control exactly what the AI know and answer",
    },
    {
      title: "Always Online",
  ...
  return (
    <div
      className="min-h-screen bg-linear-to-br from-white to-zinc-50
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {email ? (
            ...
            font-semibold hover:scale-140 transition"
            ...
            <motion.button
             ...
             text-sm font-medium hover:bg-zinc-800 transition disabled:opacity-60
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-semibold leading-tight">
              ...
              Built for Morder Website
            </h1>
            <p className="mt-6 text-zinc-600 max-w-xl">
              Add a powerful AI chatbot to your website in minutes. Let your
              customers get instant answer using your oen business knowledge.
            </p>
            <div className="mt-10 flex gap-4">
              {email ? (
                <button
                onClick={()=>navigate.push("/dashboard")}
                  className="px-7 py-3 rounded-xl bg-black
            text-white font-medium hover:bg-zinc-800 transition disabled:opacity-60"
                >
                  Go to DashBoard
                </button>
              ) : (
            ...
            text-white font-medium hover:bg-zinc-800 transition disabled:opacity-60"
              ...
              <a
                href="#feature"
                className="px-7 py-3 rounded-xl border border-zinc-300
          ...
          >
            <div className="rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -right-6 w-14
             h-14 rounded-full bg-black text-white flex items-center
